...
{
    internal class FeedbacksHttpService : IWbSellerFeedbacksHttpService
    {
        ...
        Task<HttpResponseMessage> IWbSellerFeedbacksHttpService.SendResponseAsync(SendResponseBody body)
        {
            throw new NotImplementedException();
        }
    }
