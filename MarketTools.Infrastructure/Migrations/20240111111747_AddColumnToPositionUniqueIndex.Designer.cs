...
namespace MarketTools.Infrastructure.Migrations
{
    ...
    [Migration("20240111111747_AddColumnToPositionUniqueIndex")]
    partial class AddColumnToPositionUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketTools.Domain.Entities.StandardAutoresponderTemplateArticleEntity", b =>
                {
                    ...
                    b.HasIndex(new[] { "TemplateId", "Article" }, "UniqueArticlesIndex")
                        .IsUnique();
